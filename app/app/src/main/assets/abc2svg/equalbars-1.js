...
fmt.stretchlast=1},set_sym_glue:function(of,width){var C=abc2svg.C,s,s2,w,i,n,x,g,t,t0,bars=[],tsfirst=this.get_tsfirst();of(width)
...
d=this.equalbars_d
w=(width-d)/(t-t0)
for(i=0;i<n;i++){do{s2.x=d+s2.x-x
...
if(!abc2svg.mhooks)abc2svg.mhooks={};abc2svg.mhooks.equalbars=abc2svg.equalbars.set_hooks;abc2svg.modules.equalbars.loaded=true