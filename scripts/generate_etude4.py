...
# ETUDE4: Each 4/4 bar develops ONE chord family in L-R-R-L pattern.
# Tonal journey: I → IV → V → ii → iii → vi → vii° → tonic reprise.
# 22 bars × 4 beats = 88 slots. 85 cells + 2 rests + 1 tonic reprise at end.
ETUDE = [
    # ── Bars 1-4: TONIC I (all 14 I-family cells) ──
    # Bar 1: I triads — root + inversions
    {'s':'I',        'l':('33',0)},  {'s':'I\u00b9',   'r':('43',4)},
    {'s':'I\u00b2',  'r':('34',2)},  {'s':'I+8',       'l':('334',0)},
    # Bar 2: IΔ — four voicings
    {'s':'I\u0394',  'l':('333',0)}, {'s':'I\u0394\u00b9','r':('233',6)},
    {'s':'I\u0394\u00b2','r':('323',4)}, {'s':'I\u0394\u00b3','l':('332',2)},
    # Bar 3: I6 + Is sus
    {'s':'I6',       'l':('332',0)}, {'s':'I6\u00b9',  'r':('434',4)},
    {'s':'Is2',      'r':('24',0)},  {'s':'Is4',       'l':('42',0)},
    # Bar 4: Is4+8 + IΔ leftover + IVs2 + IV intro
    {'s':'Is4+8',    'l':('424',0)}, {'s':'I\u0394\u00b3','r':('434',6)},
    {'s':'IVs2',     'r':('24',3)},  {'s':'IV\u00b9',  'l':('43',0)},
    # ── Bars 5-7: SUBDOMINANT IV (all 12 IV-family cells) ──
    # Bar 5: IV triads + IVΔ root
    {'s':'IV',       'l':('33',3)},  {'s':'IV\u00b2',  'r':('34',5)},
    {'s':'IV+8',     'r':('334',3)}, {'s':'IV\u0394',  'l':('333',3)},
    # Bar 6: IVΔ inversions
    {'s':'IV\u0394\u00b2','l':('323',0)}, {'s':'IV\u0394\u00b9','r':('233',2)},
    {'s':'IV\u0394\u00b3','r':('332',5)}, {'s':'IV\u0394\u00b3','l':('434',2)},
    # Bar 7: IV6 + V intro
    {'s':'IV6',      'l':('332',3)}, {'s':'IV6\u00b9', 'r':('434',0)},
    {'s':'V\u00b9',  'r':('43',1)},  {'s':'V',         'l':('33',4)},
    # ── Bars 8-11: DOMINANT V (all 15 V-family cells) ──
    # Bar 8: V triads leftover + V7 root/1st inv
    {'s':'V\u00b2',  'l':('34',6)},  {'s':'V+8',       'r':('334',4)},
    {'s':'V7',       'r':('333',4)}, {'s':'V7\u00b9',  'l':('233',3)},
    # Bar 9: V7 inversions + V6 root
    {'s':'V7\u00b2', 'l':('323',1)}, {'s':'V7\u00b3',  'r':('332',6)},
    {'s':'V7\u00b3', 'r':('434',3)}, {'s':'V6',        'l':('332',4)},
    # Bar 10: V6 alt + Vs
    {'s':'V6\u00b9', 'l':('434',1)}, {'s':'Vs2',       'r':('24',4)},
    {'s':'Vs4',      'r':('42',4)},  {'s':'Vs4+8',     'l':('424',4)},
    # Bar 11: Vq + ii intro
    {'s':'Vq',       'l':('44',4)},  {'s':'ii',        'r':('33',1)},
    {'s':'ii\u00b9', 'r':('43',5)},  {'s':'ii\u00b2',  'l':('34',3)},
    # ── Bars 12-14: SUPERTONIC ii (all 14 ii-family cells) ──
    # Bar 12: ii+8 + iim7 voicings
    {'s':'ii+8',     'l':('334',1)}, {'s':'iim7',      'r':('333',1)},
    {'s':'iim7\u00b9','r':('233',0)},{'s':'iim7\u00b2','l':('323',5)},
    # Bar 13: iim6 + iis
    {'s':'iim6',     'l':('332',1)}, {'s':'iim6\u00b9','r':('434',5)},
    {'s':'iis2',     'r':('24',1)},  {'s':'iis4',      'l':('42',1)},
    # Bar 14: iis4+8 + iiq + iii intro
    {'s':'iis4+8',   'l':('424',1)}, {'s':'iiq',       'r':('44',1)},
    {'s':'iiq7',     'r':('444',1)}, {'s':'iii',       'l':('33',2)},
    # ── Bars 15-17: MEDIANT iii (all 10 iii-family cells) ──
    # Bar 15: iii triads + iiim7 root
    {'s':'iii\u00b9','l':('43',6)},  {'s':'iii\u00b2', 'r':('34',4)},
    {'s':'iii+8',    'r':('334',2)}, {'s':'iiim7',     'l':('333',2)},
    # Bar 16: iiim7 inversions + iiis4 + iiiq
    {'s':'iiim7\u00b9','l':('233',1)},{'s':'iiim7\u00b2','r':('323',6)},
    {'s':'iiis4',    'r':('42',2)},  {'s':'iiiq',      'l':('44',2)},
    # Bar 17: iiiq7 + vi intro
    {'s':'iiiq7',    'l':('444',2)}, {'s':'vi',        'r':('33',5)},
    {'s':'vi\u00b9', 'r':('43',2)},  {'s':'vi\u00b2',  'l':('34',0)},
    # ── Bars 18-19: SUBMEDIANT vi (remaining 8 vi cells) ──
    # Bar 18: vi+8 + vim7 voicings
    {'s':'vi+8',     'l':('334',5)}, {'s':'vim7',      'r':('333',5)},
    {'s':'vim7\u00b9','r':('233',4)},{'s':'vim7\u00b2','l':('323',2)},
    # Bar 19: vis + viq
    {'s':'vis4',     'l':('42',5)},  {'s':'vis2',      'r':('24',5)},
    {'s':'viq',      'r':('44',5)},  {'s':'viq7',      'l':('444',5)},
    # ── Bars 20-22: LEADING TONE vii° + RESOLUTION ──
    # Bar 20: vii° triads
    {'s':'vii\u00b0\u00b9','l':('43',3)},{'s':'vii\u00b0','r':('33',6)},
    {'s':'vii\u00b0\u00b2','r':('34',1)},{'s':'vii\u00b0+8','l':('334',6)},
    # Bar 21: viiø7 + viiq
    {'s':'vii\u00f87\u00b2','l':('323',3)},{'s':'vii\u00f87','r':('333',6)},
    {'s':'vii\u00f87\u00b9','r':('233',5)},{'s':'viiq',  'l':('44',6)},
    # Bar 22: viiq7 + PAUSE + final tonic reprise
    {'s':'viiq7',    'l':('444',6)},
    {},  # rest
    {},  # rest
    {'s':'I (final)','l':('33',0)},  # reprise of opening tonic
]
...
def generate_abc(key_root=7):
    ...
    lines.append('%%staffsep 42')
    lines.append('%%sysstaffsep 18')
    lines.append('%%barsperstaff 6')
    lines.append('%%notespacingfactor 1.3')
    lines.append('%%gchordfont DejaVu Sans 13')
    lines.append('%%annotationfont DejaVu Sans 11')
...
def generate_html(abc_text, key_root=7):
    return _shared_generate_html(abc_text, key_root, ETUDE, title='Etude (v4)')
...
if __name__ == '__main__':
    ...
    abc_path = os.path.join(os.path.dirname(__file__), '..', 'handout', 'etude4.abc')
    with open(abc_path, 'w') as f:
        f.write(abc)
    print(f'Written {abc_path}')

    html_path = os.path.join(os.path.dirname(__file__), '..', 'handout', 'etude4.html')
