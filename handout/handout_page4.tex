...
\sect{Practice}{%
\begin{itemize}
  \item \textbf{Feedback loop, every rep}: set a specific target, play, judge honestly, adjust the next rep
  \item \textbf{Hardest first}: open the session while fresh; end with easy review---attention declines
\end{itemize}%
}
