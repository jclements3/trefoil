...
def main():
    ...
    for page_num, ((k1_name, k1_abc, k1_trans), (k2_name, k2_abc, k2_trans)) in enumerate(pairs, 1):
        ...
        # ── Music page ──────────────────────────────────────────────────────
        abc_path = f'/home/claude/trefoil_{k1_name}_{k2_name}.abc'
        ps_path  = f'/home/claude/trefoil_{k1_name}_{k2_name}.ps'
        ...
        music_raw = f'/home/claude/trefoil_music_{k1_name}_{k2_name}.pdf'
