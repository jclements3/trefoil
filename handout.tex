...
>{\centering\arraybackslash\columncolor{mode1}}p{23mm}
>{\centering\arraybackslash\columncolor{mode2}}p{23mm}
>{\centering\arraybackslash\columncolor{mode3}}p{23mm}
>{\centering\arraybackslash\columncolor{mode4}}p{23mm}
>{\centering\arraybackslash\columncolor{mode5}}p{23mm}
>{\centering\arraybackslash\columncolor{mode6}}p{23mm}
>{\centering\arraybackslash\columncolor{mode7}}p{23mm}}
\shortstack{\rule{0pt}{1pt}\\\phantom{x}\\[2pt]{\fontsize{14}{16}\selectfont$\hookrightarrow$\raisebox{0.3ex}{\footnotesize+}}} &
\cellcolor{hdr1}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Ionian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 1}\strut}} &
\cellcolor{hdr2}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Dorian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 2}\strut}} &
\cellcolor{hdr3}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Phrygian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 3}\strut}} &
\cellcolor{hdr4}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Lydian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 4}\strut}} &
\cellcolor{hdr5}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Mixolydian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 5}\strut}} &
\cellcolor{hdr6}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Aeolian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 6}\strut}} &
\cellcolor{hdr7}\color{white}{\shortstack{\rule{0pt}{2pt}\\{\fontsize{12}{13}\selectfont Locrian}\\[-1pt]{\fontsize{24}{26}\selectfont\bfseries 7}\strut}} \\
\arrayrulecolor{white}\setlength{\arrayrulewidth}{2pt}
